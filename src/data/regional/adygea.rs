...
/// Региональный overlay-календарь: Республика Адыгея, 2027 год.
pub(crate) const Y2027: YearFact = YearFact {
    holidays: months! {
        // Указ Главы Республики Адыгея от 14.08.2026 N 104: Ураза-Байрам.
        Mar: [9],
        // Указ Главы Республики Адыгея от 14.08.2026 N 104: День поминовения усопших (Радоница) и Курбан-Байрам.
        May: [11, 16],
        // Закон Республики Адыгея от 14.02.1995 N 168-1: День образования Республики Адыгея.
        Oct: [5],
    },
