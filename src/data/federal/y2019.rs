...
/// Официальный производственный календарь на 2019 год.
///
...
pub(crate) const Y2019: YearFact = YearFact {
    ...
    extra_days_off: months! {
        May: [2, 3, 10],  // переносы: 5 янв (сб)→2 мая (чт), 6 янв (вс)→3 мая (пт), 23 фев (сб)→10 мая (пт)
    },
    ...
    short_days: months! {
        ...
        Nov: [1],   // перед 4 ноября
    },

    transferred_days: months! {
        Jan: [5, 6],     // источники переносов (праздники на выходных)
        Feb: [23],       // источник (праздник на выходном)
